...
import copy
import numpy as np
from functions import PAD_TOKEN, device, get_dataloaders, init_weights, train_loop, eval_loop
...
for x in pbar:
	...
	if x % 1 == 0:
		slots_f1, intent_acc, loss_dev, _ = eval_loop(dev_loader, criterion_slots, criterion_intents, model, lang) 
